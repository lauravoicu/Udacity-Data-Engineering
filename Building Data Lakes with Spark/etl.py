...
def process_song_data(spark, input_data, output_data):
    """
    Process the songs data from the json files
    :param spark: created spark session
    :param input_data: location of the input data 
    :param output_data: location of the output data
    :return:
    """
...
def process_log_data(spark, input_data, output_data):
    """
    Process all event logs of the Sparkify app usage
    :param spark: created spark session
    :param input_data: location of the input data 
    :param output_data: location of the output data
    :return:
...
def main():
    """
        ETL: Extract songs and events data from S3, Transform it into dimensional tables format, and Load it back to S3 in Parquet format
    """
    spark = create_spark_session()
    input_data = "s3a://udacity-dend/"
    output_data = "s3a://udacity-dend-sparkify-datalake/"
